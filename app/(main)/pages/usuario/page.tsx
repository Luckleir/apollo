            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        onSelectionChange={(e) =>
                            setSelectedUsuarios(e.value as any)
                        }
                        dataKey="id"
                        paginator
                        rows={10}
